...
const TONE_SAMPLE_URL = `${sAssetBase}sounds/tone_c_0.mp3`;
const CHOP_WOOD_URL = `${sAssetBase}sounds/chop_wood.mp3`;
const PICK_AXE_URL = `${sAssetBase}sounds/pick_axe.mp3`;
const TREE_FALL_URL = `${sAssetBase}sounds/tree_fall.mp3`;
const ROCKS_FALL_URL = `${sAssetBase}sounds/rocks_fall.mp3`;
const PAPER_RUSTLE_URL = `${sAssetBase}sounds/paper_rustle.mp3`;
const PLANT_PULL_URL = `${sAssetBase}sounds/plant_pull.mp3`;
const HOWLING_WIND_URL = `${sAssetBase}sounds/howling_wind.mp3`;
const FOOTSTEP_GRASS_URL = `${sAssetBase}sounds/footstep_grass.wav`;
const FOOTSTEP_DIRT_URL = `${sAssetBase}sounds/footstep_dirt.wav`;
